...
This is the **binary** distribution of Xemu (**20240807161529**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Wed Aug  7 14:20:42 GMT 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: master)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/624900908**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 14:20  up 5 mins, 2 users, load averages: 2.17 3.91 2.18**
...
* TRAVIS_JOB_ID = 624900908
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 1404.3
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/624900908
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 214341fc
* TRAVIS_TIMER_START_TIME = 1723040442300943000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.lpyBf2pp
