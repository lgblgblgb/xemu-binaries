...
This is the **binary** distribution of Xemu (**20210305194749**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Fri Mar  5 20:37:58 GMT 2021**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: next)**
* **BUILD_LOG_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761630687**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 20:37  up 5 mins, 2 users, load averages: 1.89 3.86 2.28**
...
* TRAVIS_JOB_ID = 761630687
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 992.3
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761630687
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 04721550
* TRAVIS_TIMER_START_TIME = 1614976678472529000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.l55sYRZ9
