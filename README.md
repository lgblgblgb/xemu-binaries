...
This is the **binary** distribution of Xemu (**20210305200506**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Fri Mar  5 19:13:25 GMT 2021**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: dev)**
* **BUILD_LOG_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761622430**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 19:13  up 5 mins, 2 users, load averages: 2.24 4.07 2.37**
...
* TRAVIS_JOB_ID = 761622430
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 991.3
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761622430
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 35fdd32e
* TRAVIS_TIMER_START_TIME = 1614971605530532000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.pmTKyKuR
