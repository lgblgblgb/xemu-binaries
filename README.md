...
This is the **binary** distribution of Xemu (**20240807161529**) for **Windows**. For the source code, further
...
* **BUILD_DATE = Wed Aug  7 02:23:36 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: master)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/624900907**
...
* **BUILD_UPTIME =  14:23:36 up 7 min,  1 user,  load average: 1.52, 0.91, 0.39**
...
* TRAVIS_JOB_ID = 624900907
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 1404.2
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/624900907
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 04d7e9ef
* TRAVIS_TIMER_START_TIME = 1723040616843174125
* TRAVIS_TMPDIR = /tmp/tmp.Uphxp10QSw
* TRAVIS_UID = 2000
