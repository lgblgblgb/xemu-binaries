...
This is the **binary** distribution of Xemu (**20241022012831**) for **Windows**. For the source code, further
...
* **BUILD_DATE = Mon Oct 21 11:36:36 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: next)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627337928**
...
* **BUILD_UPTIME =  23:36:36 up 5 min,  1 user,  load average: 1.43, 0.94, 0.41**
...
* TRAVIS_JOB_ID = 627337928
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 1422.2
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627337928
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 1357f57c
* TRAVIS_TIMER_START_TIME = 1729553796844469431
* TRAVIS_TMPDIR = /tmp/tmp.0lqKgbgvgH
* TRAVIS_UID = 2000
