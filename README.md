...
This is the **binary** distribution of Xemu (**20240324232624**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Sun Mar 24 22:32:43 GMT 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: next)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619640390**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 22:32  up 3 mins, 2 users, load averages: 6.07 5.39 2.46**
...
* TRAVIS_JOB_ID = 619640390
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 1390.3
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619640390
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 04ab53c5
* TRAVIS_TIMER_START_TIME = 1711319563283161000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.nGfd0AeI
