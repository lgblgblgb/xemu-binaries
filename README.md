...
This is the **binary** distribution of Xemu (**20240324232624**) for **Windows**. For the source code, further
...
* **BUILD_DATE = Sun Mar 24 10:35:24 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: next)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619640389**
...
* **BUILD_UPTIME =  22:35:24 up 5 min,  1 user,  load average: 1.58, 1.01, 0.45**
...
* TRAVIS_JOB_ID = 619640389
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 1390.2
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619640389
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 073dbd2e
* TRAVIS_TIMER_START_TIME = 1711319724022521192
* TRAVIS_TMPDIR = /tmp/tmp.y7GLWDRQjT
* TRAVIS_UID = 2000
