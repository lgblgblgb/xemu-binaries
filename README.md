...
This is the **binary** distribution of Xemu (**20210302012957**) for **Linux**. For the source code, further
...
* TRAVIS_JOB_ID = 761044487
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 987.1
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761044487
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 02e2e4e0
* TRAVIS_TIMER_START_TIME = 1614645988152066786
* TRAVIS_TMPDIR = /tmp/tmp.ICDqBoNHW5
* TRAVIS_UID = 2000
