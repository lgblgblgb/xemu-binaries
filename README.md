...
This is the **binary** distribution of Xemu (**20241022012831**) for **Linux**. For the source code, further
...
* **BUILD_DATE = Mon Oct 21 11:34:26 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: next)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627337927**
...
* **BUILD_TARGET = Linux**
* **BUILD_UPTIME =  23:34:26 up 2 min,  1 user,  load average: 1.37, 0.59, 0.23**
...
* TRAVIS_JOB_ID = 627337927
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 1422.1
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627337927
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 0a310262
* TRAVIS_TIMER_START_TIME = 1729553666026911599
* TRAVIS_TMPDIR = /tmp/tmp.8ZezX3qk3b
* TRAVIS_UID = 2000
