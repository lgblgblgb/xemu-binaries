...
This is the **binary** distribution of Xemu (**20240228183812**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Wed Feb 28 17:41:31 GMT 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: master)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/618474017**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 17:41  up 3 mins, 2 users, load averages: 5.90 4.99 2.27**
...
* TRAVIS_JOB_ID = 618474017
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 1384.3
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/618474017
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 0210b378
* TRAVIS_TIMER_START_TIME = 1709142091328119000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.9D6jXzKr
