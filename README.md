...
This is the **binary** distribution of Xemu (**20241022151724**) for **Linux**. For the source code, further
...
* **BUILD_DATE = Tue Oct 22 01:35:47 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: dev)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627364813**
...
* **BUILD_TARGET = Linux**
* **BUILD_UPTIME =  13:35:47 up 2 min,  1 user,  load average: 1.65, 0.75, 0.29**
...
* TRAVIS_JOB_ID = 627364813
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 1424.1
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627364813
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 068a807c
* TRAVIS_TIMER_START_TIME = 1729604147417145911
* TRAVIS_TMPDIR = /tmp/tmp.pNAsjvO1b2
* TRAVIS_UID = 2000
