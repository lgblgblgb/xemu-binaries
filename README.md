...
This is the **binary** distribution of Xemu (**20240324213138**) for **Linux**. For the source code, further
...
* **BUILD_DATE = Sun Mar 24 08:35:26 PM UTC 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: dev)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619639726**
...
* **BUILD_TARGET = Linux**
* **BUILD_UPTIME =  20:35:26 up 3 min,  1 user,  load average: 1.44, 0.72, 0.28**
...
* TRAVIS_JOB_ID = 619639726
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 1389.1
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619639726
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 3913c10a
* TRAVIS_TIMER_START_TIME = 1711312526590260195
* TRAVIS_TMPDIR = /tmp/tmp.PfDE0cfME4
* TRAVIS_UID = 2000
