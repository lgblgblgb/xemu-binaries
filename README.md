...
This is the **binary** distribution of Xemu (**20210126001453**) for **Windows**. For the source code, further
...
* TRAVIS_JOB_ID = 756174746
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 967.2
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/756174746
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 126855fe
* TRAVIS_TIMER_START_TIME = 1611622987519650588
* TRAVIS_TMPDIR = /tmp/tmp.hlsMC5RRux
* TRAVIS_UID = 2000
