...
This is the **binary** distribution of Xemu (**20240324213138**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Sun Mar 24 20:35:16 GMT 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: dev)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619639728**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 20:35  up 3 mins, 2 users, load averages: 5.50 4.76 2.17**
...
* TRAVIS_JOB_ID = 619639728
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 1389.3
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/619639728
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 1559a254
* TRAVIS_TIMER_START_TIME = 1711312516319990000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.DSsktixy
