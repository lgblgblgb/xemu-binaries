...
This is the **binary** distribution of Xemu (**20210305200506**) for **Linux**. For the source code, further
...
* TRAVIS_JOB_ID = 761622428
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 991.1
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761622428
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 2898d19b
* TRAVIS_TIMER_START_TIME = 1614971967358911354
* TRAVIS_TMPDIR = /tmp/tmp.SnN6I9Mo0h
* TRAVIS_UID = 2000
