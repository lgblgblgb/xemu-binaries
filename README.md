...
This is the **binary** distribution of Xemu (**20210107201413**) for **Windows**. For the source code, further
...
* TRAVIS_JOB_ID = 753410757
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 927.2
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/753410757
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 0bf6289a
* TRAVIS_TIMER_START_TIME = 1610048583910113719
* TRAVIS_TMPDIR = /tmp/tmp.0rI7jOFufY
* TRAVIS_UID = 2000
