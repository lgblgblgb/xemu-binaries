...
This is the **binary** distribution of Xemu (**20210305194749**) for **Windows**. For the source code, further
...
* TRAVIS_JOB_ID = 761630686
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 992.2
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761630686
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 066501de
* TRAVIS_TIMER_START_TIME = 1614976752523226641
* TRAVIS_TMPDIR = /tmp/tmp.mbvH6XUOyz
* TRAVIS_UID = 2000
