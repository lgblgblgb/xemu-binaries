...
This is the **binary** distribution of Xemu (**20241022151724**) for **MacOS**. For the source code, further
...
* **BUILD_DATE = Tue Oct 22 13:36:05 GMT 2024**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: dev)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627364815**
...
* **BUILD_TARGET = MacOS**
* **BUILD_UPTIME = 13:36  up 3 mins, 2 users, load averages: 4.40 4.63 2.19**
...
* TRAVIS_JOB_ID = 627364815
* TRAVIS_JOB_NAME = MacOS native compilation
* TRAVIS_JOB_NUMBER = 1424.3
* TRAVIS_JOB_RESTARTED = false
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/627364815
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 0b016384
* TRAVIS_TIMER_START_TIME = 1729604165220872000
* TRAVIS_TMPDIR = /var/folders/17/5mc7816d3mndxjqgplq6057w0000gn/T/tmp.VhKR3VTo
