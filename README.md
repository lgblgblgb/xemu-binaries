...
This is the **binary** distribution of Xemu (**20210302012957**) for **Windows**. For the source code, further
...
* **BUILD_DATE = Tue 02 Mar 2021 12:47:56 AM UTC**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: hmw)**
* **BUILD_LOG_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761044488**
* **BUILD_OS = (linux) Linux lgb 5.4.0-1036-gcp #39-Ubuntu SMP Thu Jan 14 18:41:17 UTC 2021 x86_64 x86_64 x86_64 GNU/Linux**
* **BUILD_TARGET = Windows**
* **BUILD_UPTIME =  00:47:56 up 4 min,  1 user,  load average: 1.75, 1.14, 0.50**
...
* TRAVIS_JOB_ID = 761044488
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 987.2
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/761044488
* TRAVIS_LANGUAGE = c
* TRAVIS_OS_NAME = linux
* TRAVIS_PRE_CHEF_BOOTSTRAP_TIME = 2021-02-23T09:45:44
...
* TRAVIS_STACK_TIMESTAMP = 2021-02-23 09:45:55 UTC
* TRAVIS_SUDO = true
* TRAVIS_TEST_RESULT = 0
* TRAVIS_TIMER_ID = 16ed5fa8
* TRAVIS_TIMER_START_TIME = 1614646076258049727
* TRAVIS_TMPDIR = /tmp/tmp.MxlcFLxyB3
* TRAVIS_UID = 2000
