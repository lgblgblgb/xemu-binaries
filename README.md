...
This is the **binary** distribution of Xemu (**20240228183812**) for **Linux**. For the source code, further
...
* **BUILD_DATE = Wed 28 Feb 2024 05:41:19 PM UTC**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: master)**
* **BUILD_LOG_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/618474015**
...
* **BUILD_TARGET = Linux**
* **BUILD_UPTIME =  17:41:19 up 2 min,  1 user,  load average: 1.65, 0.76, 0.30**
...
* TRAVIS_JOB_ID = 618474015
* TRAVIS_JOB_NAME = Linux native compilation
* TRAVIS_JOB_NUMBER = 1384.1
* TRAVIS_JOB_WEB_URL = https://app.travis-ci.com/lgblgblgb/xemu/jobs/618474015
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 1190f1cb
* TRAVIS_TIMER_START_TIME = 1709142079591125156
* TRAVIS_TMPDIR = /tmp/tmp.YJ8eTxpMLN
* TRAVIS_UID = 2000
