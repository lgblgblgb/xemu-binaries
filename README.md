...
This is the **binary** distribution of Xemu for **Windows**. For the source code, further
...
* **BUILD_DATE = Sun Aug  2 16:14:42 UTC 2020**
* **BUILD_GIT_REMOTE = https://github.com/lgblgblgb/xemu.git (branch: master)**
* **BUILD_LOG_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/714236915**
...
* **BUILD_UPTIME =  16:14:42 up 3 min,  1 user,  load average: 1.93, 0.97, 0.39**
...
* TRAVIS_JOB_ID = 714236915
* TRAVIS_JOB_NAME = Windows cross-compilation on Linux
* TRAVIS_JOB_NUMBER = 744.2
* TRAVIS_JOB_WEB_URL = https://travis-ci.org/lgblgblgb/xemu/jobs/714236915
* TRAVIS_LANGUAGE = c
...
* TRAVIS_TIMER_ID = 1949e57e
* TRAVIS_TIMER_START_TIME = 1596384882739331750
* TRAVIS_TMPDIR = /tmp/tmp.ygqlhwZULo
* TRAVIS_UID = 2000
